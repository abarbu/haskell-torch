...
stack_yaml = """resolver: nightly-2020-08-03
compiler: ghc-git-b23be83f2cb24ed33005021fbc5dd8b0eff50bd5-{3}
compiler-repository: https://github.com/abarbu/ghc.git
...
with open("stack.yaml", "w") as f:
    f.write(stack_yaml.format(os.environ['CONDA_PREFIX'],
                              ...
                              ("quick" if quickGhc else "default")))
